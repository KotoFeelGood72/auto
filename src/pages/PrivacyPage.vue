      ...
      <div class="content">
        ...
        <div class="block-term">
          ...
          <ul>
            <li>
              ...
              управления сайтом, действующие от его имени, которые организуют и
            ...
            <li>
              ...
              доступ к сайту, посредством сети Интернет и использующее данный
              сайт для своих целей.
            </li>
            <li>
        ...
        <div class="block-term">
          ...
          <p>
            ...
            просмотров, используемые браузеры и операционные системы и т.д.) не
        ...
        <div class="block-term">
          ...
          <ul>
            ...
            <li>
              4.1.6. Создания учетной записи для совершения покупок (при наличии
              такого сервиса), если Пользователь дал согласие на создание
              учетной записи.
            </li>
            <li>
              4.1.7. Уведомления Пользователя сайта о состоянии Заказа (при
              наличии такого сервиса).
            </li>
            <li>
            ...
            <li>
              4.1.11. Предоставления доступа Пользователю на сторонние сайты или
        ...
        <div class="block-term">
          ...
          <ul>
            <li>
              6.1.1. Предоставить корректную и правдивую информацию о
            ...
            <li>6.2. Администрация сайта обязуется:</li>
            <li>
