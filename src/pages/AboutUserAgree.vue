...
const updateSeo = () => {
  ...
  const description = `Купить новый Автомобиль в Москве | Автокредит - Ознакомьтесь с нашим ассортиментом и выберите идеальный автомобиль. Удобные условия покупки, кредит и тест-драйв.`;
