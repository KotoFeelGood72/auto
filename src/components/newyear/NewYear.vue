  ...
  <div class="b-page_newyear">
    <div class="b-page__content">
      <i class="b-head-decor">
        <!-- Внешний цикл для групп шаров -->
        <i
          v-for="groupIndex in 7"
          :key="'group-' + groupIndex"
          :class="['b-head-decor__inner', `b-head-decor__inner_n${groupIndex}`]"
        >
          <!-- Внутренний цикл для шаров с bounce -->
          <div
            v-for="noteIndex in 9"
            :key="'ball-' + groupIndex + '-' + noteIndex"
            :class="['b-ball', `b-ball_n${noteIndex}`, 'b-ball_bounce']"
            :data-note="(groupIndex - 1) * 9 + (noteIndex - 1)"
            @mouseenter="playBallSound"
            @mouseleave="stopBallSound"
          >
            <div class="b-ball__right"></div>
            <div class="b-ball__i"></div>
          </div>

          <!-- Внутренний цикл для дополнительных шаров -->
          <div
            v-for="extraIndex in 6"
            :key="'extra-ball-' + groupIndex + '-' + extraIndex"
            :class="['b-ball', `b-ball_i${extraIndex}`]"
          >
            <div class="b-ball__right"></div>
            <div class="b-ball__i"></div>
          </div>
